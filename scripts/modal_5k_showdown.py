...
def run_model_eval(model_name: str):
    ...
    if model_name == "nanogpt":
        ...
        config = {"num_layers": 6, "expansion": 4, "iterations": 4, "use_decay": True}
...
def main():
    ...
    print("Launching 5k-step Showdown on Modal...")
    ...
    with open("data/5k_showdown_results.json", "w") as f:
        json.dump(final_dict, f)
        
    print("5k Showdown complete! Results saved to data/5k_showdown_results.json")
